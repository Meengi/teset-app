    ...
    return (
        <nav className={x.nav}>
            <div className={x.side_bar}>
                <div className={x.side_bar_in}>
                    <NavLink to="/profile" className={navData => navData.isActive ? x.active : x.item}>
                        <div className={x.side_bar_icon}>
                ...
                <div>
                    <NavLink to="/messages" className={navData => navData.isActive ? x.active : x.item}>
                        <div className={x.side_bar_icon}>
                ...
                <div>
                    <NavLink to="/news" className={navData => navData.isActive ? x.active : x.item}>
                        <div className={x.side_bar_icon}>
                            <svg fill="none" height="20" viewBox="0 0 20 20" width="20"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path clip-rule="evenodd"
                ...
                <div>
                    <NavLink to="/music" className={navData => navData.isActive ? x.active : x.item}>
                        <div className={x.side_bar_icon}>
                ...
                <div>
                    <NavLink to="/settings"
                             className={navData => navData.isActive ? x.active : x.item}>
                        <div className={x.side_bar_icon}>
